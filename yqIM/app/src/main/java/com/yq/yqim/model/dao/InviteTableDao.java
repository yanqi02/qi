...
public class InviteTableDao {
    ...
    public void addInvitation(InvationInfo invationInfo) {
        ...
        if (user != null) {//联系人
            ...
            values.put(InviteTable.GROUP_HXID, invationInfo.getGroup().getGroupId());
            values.put(InviteTable.GROUP_NAME, invationInfo.getGroup().getGroupName());
            values.put(InviteTable.USER_HXID, invationInfo.getGroup().getInvatePersion());
        }
